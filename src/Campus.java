...
/**
 * Modifications of the Campus class
 * 
 * we changed NUMBER_OF_ROWS and NUMBER_OF_COLUMNS of rows and number of columns to 40. 
 */
...
public class Campus {
    private Cell[][] cells; // cells is a 3D Array that holds objects of type CELL
    ...
    public void initializeCampus() {
        ...
        for (int ii = 0; ii < NUMBER_OF_ROWS; ii++) {
            for (int jj = 0; jj < NUMBER_OF_COLUMNS; jj++) {
                ...
                cells[ii][jj] = new Cell(ii, jj, wallLocations[ii][jj]); // Can add other stractures.
